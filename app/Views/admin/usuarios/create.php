            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <?php endif; ?>
                        <?php if (isset($codigoDuplicado)) : ?>
                        <div class="text-danger"><?= $codigoDuplicado ?></div>
                        <?php endif; ?>
                    </div>
                </div>
                <div class="col-md-4">
            ...
            <div class="row">
                <div class="col md-4">
                    ...
                    <div class="form-group">
                        ...
                        <?php endif; ?>
                        <?php if (isset($emailDuplicateError)) : ?>
                        <div class="text-danger"><?= $emailDuplicateError ?></div>
                        <?php endif; ?>
                    </div>
                ...
                <div class="col md-4">
                    <div class="form-group mb-3 has-validation">
                        ...
                        <input type="password"
                            ...
                            name="password" placeholder="Tu contraseña" value="<?php echo set_value('password'); ?>" />
